        ...
        <div className="game-scores">
          ...
          <div className="game-scores-chart">
            <table className="result-table">
              <tbody>
                <tr><th >Player Name:</th><td>{userName}</td></tr>
                <tr><th >Total Trials:</th><td>{trials}</td></tr>
                <tr><th >Total Points:</th><td>{totalScore}</td></tr>
                <tr><th >Right:</th><td>{totalCorrect}</td></tr>
                <tr><th >Wrong:</th><td>{totalIncorrect}</td></tr>
              </tbody>
            </table>
